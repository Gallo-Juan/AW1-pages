            ...
            <div class="card bg-card h-100 w-100 d-flex flex-column">
              ...
              <div class="card-footer">
                <div class="row text-center align-items-center">
                  ...
                  <div class="col-3">
                    <button class="btn btn-comprar" data-id="${id}" data-nombre="${nombre}" data-texto="${texto}" data-imagen="${imagen}" data-precio="${precio}"><img src="/AW1-pages/imgs/carrito.png" style="width:30px"></button>
                  </div>
                </div>           
              </div> 
            </div>  
